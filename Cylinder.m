 function [Cylinder EndPlate1 EndPlate2] = Cylinder(X1,X2,r,n,cyl_color,cyl_alpha,closed,lines)
%
...
set(Cylinder,'FaceAlpha',cyl_alpha)
if closed==1
    set([EndPlate1 EndPlate2],'FaceColor',cyl_color)
    set([EndPlate1 EndPlate2],'FaceAlpha',cyl_alpha)
else
    EndPlate1=[];
    EndPlate2=[];
end
